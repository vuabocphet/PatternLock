package com.ecoapplock.lockview;
...
import com.ecoapplock.lockview.utils.PatternLockUtils;
import com.ecoapplock.lockview.utils.ResourceUtils;
...
import static com.ecoapplock.lockview.PatternLockView.AspectRatio.ASPECT_RATIO_HEIGHT_BIAS;
import static com.ecoapplock.lockview.PatternLockView.AspectRatio.ASPECT_RATIO_SQUARE;
import static com.ecoapplock.lockview.PatternLockView.AspectRatio.ASPECT_RATIO_WIDTH_BIAS;
import static com.ecoapplock.lockview.PatternLockView.PatternViewMode.AUTO_DRAW;
import static com.ecoapplock.lockview.PatternLockView.PatternViewMode.CORRECT;
...
public class PatternLockView extends View {
     ...
     */
    @IntDef({CORRECT, AUTO_DRAW, PatternViewMode.WRONG})
    @Retention(RetentionPolicy.SOURCE)
    ...
    private List<ObserveLockView> mPatternListeners;
    ...
    public PatternLockView(Context context, AttributeSet attrs) {
        ...
        this.dimensionPixelOffset = context.getResources().getDimensionPixelOffset(R.dimen.pattern_lock_bitmap) / 2;
    ...
    public void addPatternLockListener(ObserveLockView patternListener) {
        mPatternListeners.add(patternListener);
    }

    public void removePatternLockListener(ObserveLockView patternListener) {
    ...
    private void notifyListenersStarted() {
        for (ObserveLockView patternListener : mPatternListeners) {
    ...
    private void drawCircle(Canvas canvas, float centerX, float centerY,
       ...
       /* if (partOfPattern){
            canvas.drawBitmap(this.bitmap1, centerX - dimensionPixelOffset, centerY - dimensionPixelOffset,  new Paint());
        }else {
            canvas.drawBitmap(this.bitmap, centerX - dimensionPixelOffset, centerY - dimensionPixelOffset,  new Paint());
        }*/
